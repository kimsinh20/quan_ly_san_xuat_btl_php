...
$spedit = $_GET['masp'];
$nvledit = $_GET['manvl'];
$sqlKHSX = "SELECT * FROM dinhmucnvl WHERE maSanPham='$spedit' and maNguyenVatLieu = '$nvledit';";
            ...
            <div class="form-row m-2">
                <div class="form-group col-md-12">
                    ...
                    <select class="form-select custom-select form-control-border" name="sanpham" aria-label="Default select example">
                        ...
                        ?>
                            <option style="height: 40px;" value="<?php echo $r['maSanPham']; ?>" <?= ($result['maSanPham'] == $r['maSanPham']) ? 'selected' : ''; ?>>
                                <?php echo $r['maSanPham']; ?> - <?= $r['tenSanPham'] ?>
                            </option>
                        <?php
                        }
                        ?>
                ...
                <div class="form-group col-md-12">
                    ...
                    <select class="form-select custom-select form-control-border" name="nguyenvatlieu" aria-label="Default select example">
                        ...
                        while ($r = mysqli_fetch_array($resultMaycsx)) {
                        ?>
                            <option style="height: 40px;" value="<?php echo $r['maNguyenVatLieu']; ?>" <?= ($result['maNguyenVatLieu'] == $r['maNguyenVatLieu']) ? 'selected' : ''; ?>>
                                <?php echo $r['maNguyenVatLieu']; ?> - <?= $r['tenNguyenVatLieu'] ?>
                            </option>
                        <?php
                        }
                        ?>
                ...
                <div class="form-group col-md-12" style="margin: 10px 0px;">
                    ...
                    <input type="text" class="form-control" value="<?= $result['soLuongNVL'] ?>" name="soLuongNVL" id="soLuongNVL" placeholder="">
                </div>
                <div class="col">
