            ...
            <div class="row mb-2">
                    ...
                    <h6 class="m-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb text-decoration-none">
                                <li class="breadcrumb-item"><a href="thuctesanxuat.php" class="text-success">thực tế sản xuất</a></li>
                            </ol>
                        </nav>
                    </h6>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">thực tế sản xuất</a></li>
        ...
        <div class="container-fluid">
            <div class="content-header">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" id="sort-item">
                        <li><a role="button" id="menu-item1" data-value="sản phẩm">lệnh sản xuất</a></li>
                    ...
                    <span class="label label-success label-medium" id="sort-item-value">lệnh sản xuất</span>
                </div>
            </div>
            <table class="table">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">ngày sản xuất sản xuất</th>
                        <th scope="col"></th>
                        <th scope="col"></th>
                    </tr>
                </thead>
                <tbody class="danhsach">
                    ...
                    $sql = "SELECT * FROM thuctesanxuat  inner join lenhsanxuat on  lenhsanxuat.maLenhSanXuat = thuctesanxuat.maLenhSanXuat order by thuctesanxuat.maLenhSanXuat ASC LIMIT $from, $max_results";
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="col"><?php echo $r['soLuongDaSanXuat']; ?></th>
                            <th scope="col"><?php echo $r['ngaySanXuat']; ?></th>
                            <th scope="col">
                                <a style="margin-right: 15px;" href="./suathuctesanxuat.php?id=<?= $r['maThucTeSanXuat'] ?>" class="btn btn btn-danger">sửa</a>
                                <a href="./xoathuctesanxuat.php?id=<?= $r['maThucTeSanXuat'] ?>" class="btn btn-info">xóa</a>
                            </th>
                        </tr>
                    <?php
                    }
            ...
            <footer class="footer" style="position: fixed;">
                <div class="phantrang" style="display: flex;justify-content: center;position: absolute;left: 500px">
                    ...
                    $total_results = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) as Num FROM thuctesanxuat where 1"))[0];
