                ...
                <div class="col-sm-6">
                    <h6 class="m-0">
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="qlsanpham.php" class="text-success">sản phẩm</a></li>
                            </ol>
                        </nav>
                    </h6>
                </div><!-- /.col -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="content-header">
                ...
                <a href="themsanpham.php" style="text-decoration: none;color: #fff;">thêm sản phẩm</a></button>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" id="sort-item">
                        <li><a role="button" id="menu-item1" data-value="sản phẩm">tên sản phẩm</a></li>
                    ...
                    <span class="label label-success label-medium" id="sort-item-value">tên sản phẩm</span>
                </div>
            </div>
            ...
            <table class="table  table-striped caption-top ">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">chi phí sản xuất</th>
                        <th scope="col"></th>
                        <th scope="col"></th>
                    </tr>
                </thead>
                <tbody class="danhsach table-group-divider">
                    <?php
                    ...
                    $sql = "SELECT * from sanpham  order by tenSanPham ASC LIMIT $from, $max_results";
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="col"><img src="./dist/assest/image/<?=$r['anhMinhHoa']?>" alt="err" width="50px" height="45px"></th>
                            <th scope="col"><?php echo $r['donViTinh']; ?></th>
                            <!-- <th scope="col"><?php echo $r['soLuongSP']; ?></th> -->
                            <th scope="col"><?php echo $r['chiPhiSx']; ?></th>
                            <th scope="col">
                                <a style="margin-right: 15px;" href="./suasanpham.php?id=<?= $r['maSanPham'] ?>" class="btn btn btn-danger">sửa</a>
                                <a href="./xoasanpham.php?id=<?= $r['maSanPham'] ?>" class="btn btn-info">xóa</a>
                            </th>
                        </tr>
                    <?php
                    }
            ...
            <footer class="footer" style="position: fixed;">
                <div class="phantrang" style="display: flex;justify-content: center;position: absolute;left: 500px">
                    ...
                    $total_results = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) as Num FROM sanpham where 1"))[0];
