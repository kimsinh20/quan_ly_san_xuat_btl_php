...
<div class="content-wrapper" style="background: linear-gradient(-180deg, #BCE6FF 0%, #53A6D8 100%);">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <button type="button" class="btn btn-info btn-block marginB10" id="toggle-form-button">Thêm sản phẩm</button>
            </div>
        </div>
            ...
            <table class="table table-hover ">
                ...
                <tbody id="data-body">
                    <tr>
                        ...
                        <td class="name">Tìm thấy mảnh vỡ máy bay rơi ở Iran làm 66 người chết</td>
                        <td class="category">
                            <span class="label label-info">Thể thao</span>
                        </td>
                        <td class="category">
                            <span class="label label-info">Tồn kho</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="name">Không còn tranh cướp lộc hoa tre ở lễ hội đền Gióng 2018</td>
                        <td class="category">
                            <span class="label label-success">Kinh doanh</span>
                        </td>
                        <td class="category">
                            <span class="label label-success">Hết hàng</span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-default btn-sm btn-edit">Sửa</button>
                            <button type="button" class="btn btn-danger btn-sm btn-delete">Xóa</button>
                    ...
                    <tr>
                        ...
                        <td class="name">Hơn 37.000 người nhập viện vì tai nạn giao thông, đốt pháo</td>
                        <td class="category">
                    ...
                    <tr>
                        ...
                        <td class="name">Gần 200 người chết vì tai nạn giao thông 7 ngày nghỉ Tết</td>
                        <td class="category">
                            <span class="label label-success">Kinh doanh</span>
                        </td>
                        <td class="category">
                            <span class="label label-success">Tồn kho</span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-default btn-sm btn-edit">Sửa</button>
                            <button type="button" class="btn btn-danger btn-sm btn-delete">Xóa</button>
                    ...
                    <tr>
                        ...
                        <td class="category">
                            <span class="label label-info">Còn hàng</span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-default btn-sm btn-edit">Sửa</button>
                            <button type="button" class="btn btn-danger btn-sm btn-delete">Xóa</button>
                    ...
                    <tr>
                        ...
                        <td class="category">
                            <span class="label label-default">Còn hàng</span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-default btn-sm btn-edit">Sửa</button>
                            <button type="button" class="btn btn-danger btn-sm btn-delete">Xóa</button>
